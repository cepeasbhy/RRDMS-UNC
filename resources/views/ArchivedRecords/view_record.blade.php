...
@section('content')
    <div class="row mb-3">
        <form class="mb-3" action="{{ route('show_unarchived_credential') }}" method="get">
            ...
            <div class="ms-2 mb-3">
                <div class="row align-items-center mb-3">
                    <img class="col-3 img-fluid rounded-circle student-pic" data-bs-toggle="modal"
                        ...
                        src="http://rrdms.srv/storage/{{ $picturePath->document_loc }}">
                    <div class="col-9">
    ...
    @extends('layouts.modals.StudentCredential.archiveCredModal')

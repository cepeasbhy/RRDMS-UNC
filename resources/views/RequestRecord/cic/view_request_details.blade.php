        ...
        <div class="grid-container wide-gap grid-orientation">
                                ...
                                <div>
                                    ...
                                    @foreach ($requestedDocumentDetails->diploma as $diploma)
                                        <div>
                                            ...
                                            @else
                                                <span
                                                    style="font-size: 0.75rem">₱{{ number_format($diploma['price'], 2) }}</span>
                                            @endif
                                        </div>
                                    @endforeach
                                </div>
                                        ...
                                        @foreach ($certificate as $description => $value)
                                            <div>
                                                @if ($description == 'TOTAL PRICE')
                                                    <span class="fw-bold"
                                                        style="font-size: 0.85rem">{{ $description }}</span>
                                                @else
                                ...
                                <div>
                                    ...
                                    @foreach ($requestedDocumentDetails->authentication as $auth)
                                        <div>
                                            ...
                                            @else
                                                <span
                                                    style="font-size: 0.75rem; margin: 0">{{ $auth['description'] }}</span>
                                            @endif
                                        </div>
                                    @endforeach
                                </div>
            ...
            <div class="flex-container inner">
                <div class="form-group mb-1">
                    ...
                    <input class="form-control form-control-sm" type="text" value="{{ $requestInfo->request_id }}"
                        readonly>
                </div>
                ...
                @if ($requestInfo->reason_for_rejection != null)
                    <div class="form-group mb-1">
                        ...
                        <textarea class="form-control form-control-sm" style="resize: none" readonly>{{ trim($requestInfo->reason_for_rejection) }}</textarea>
                    </div>
                @endif
            </div>
        </div>

<div id="update-modal" class="modal fade" tabindex="-1" aria-labelledby="title-modal" aria-hidden="true" style="display: none">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="update-form" action="{{route($routeName, ['id' => $student->student_id])}}" method="post">
                    ...
                    <div class="form-group mb-2">
                        <label class="col-form-label col-form-label-sm" for="">Email<span class="text-danger">*</label>
                        <input class="form-control form-control-sm @error('email') is-invalid @enderror" type="text" value="{{$student->email}}" name="email">
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group mb-2">
                        <label class="col-form-label col-form-label-sm" for="">Status<span class="text-danger">*</label>
                    ...
                    @endif
                    <div class="form-group mb-2">
                        <label class="col-form-label col-form-label-sm" for="">Admission Date</label>
                        <input class="form-control form-control-sm @error('admission_date') is-invalid @enderror" type="date" name="admission_date" value="{{$student->admission_date}}">

        ...
        <div class="grid-container wide-gap grid-orientation" style="width: 100%">
            <div>
                ...
                <div class="readonly-container" style="margin-top: 0.5rem">
                    ...
                    <input class="readonly-box" type="text" value="{{ date('Y-m-d', strtotime($student->created_at)) }}"
                        readonly>
                </div>
                <div class="readonly-container" style="margin-top: 0.5rem">
                    <label style="font-size: 0.85rem" for="">Last Updated</label>
                    <input class="readonly-box" type="text" value="{{ date('Y-m-d', strtotime($student->updated_at)) }}"
                        readonly>
                </div>
            </div>
            <div>

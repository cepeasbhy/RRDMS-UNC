        ...
        <div class="flex-container inner">
            ...
            <div>
                ...
                <div class="readonly-container" style="margin-top: 0.5rem">
                    ...
                    <input class="readonly-box" type="text" value="{{ date('Y-m-d', strtotime($student->date_archived)) }}" readonly>
                </div>
                <div class="readonly-container" style="margin-top: 0.5rem">
                    <label style="font-size: 0.85rem" for="">Date Filed</label>
                    <input class="readonly-box" type="text" value="{{ date('Y-m-d', strtotime($student->date_filed)) }}" readonly>
                </div>
                <div class="readonly-container" style="margin-top: 0.5rem">

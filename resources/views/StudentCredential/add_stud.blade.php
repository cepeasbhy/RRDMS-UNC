        ...
        <form class="row" action="{{route('submitStudent')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-5">
                ...
                <div class="ms-2">
                        <div class="form-group mb-2">
                            <label class=" col-form-label col-form-label-sm" for="">Student ID:</label>
            ...
            <div class="col">
                ...
                <div class="ms-2">
                        ...
                        <div class="form-group mb-2">
                            <label class="col-form-label-sm" for="goodMoralCharacter">Certificate of Good Moral Character</label>

        ...
        <div class="grid-container add-student-container">
            <div>
                ...
                <div class="form-pair">
                    ...
                    <input class="form-control form-control-sm @error('middle_name') is-invalid @enderror" type="text" value="{{ old('middle_name') }}" name="middle_name">
                    @error('middle_name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-pair">
                    ...
                    <input class="form-control form-control-sm @error('email') is-invalid @enderror" type="text" value="{{ old('email') }}" name="email">
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-pair">
                    ...
                    <input class="form-control form-control-sm @error('admission_date') is-invalid @enderror" type="date" value="{{ old('admission_date') }}" name="admission_date" required>
            ...
            <div>
                ...
                <div class="flex-container">
                    <div style="width: 100%">
                        ...
                        <input id="birthCertificate" class="form-control form-control-sm" type="file" name="birthCertificate">
                    </div>
                    <div style="width: 100%">
                        <label class="col-form-label-sm" for="marriageCertificate">Marriage Certificate</label>
                        <input id="marriageCertificate" class="form-control form-control-sm" type="file" name="marriageCertificate">
                    </div>
                </div>
                ...
                <div>
                    <label class="col-form-label-sm" for="goodMoralCharacter">Certificate of Good Moral
                        Character</label>
                    <input id="goodMoralCharacter" class="form-control form-control-sm" type="file" name="goodMoralCharacter">
                </div>
                <div>
                    <label class="col-form-label-sm" for="honorDismisal">Honarable Dismisal</label>
                    <input id="honorDismisal" class="form-control form-control-sm" type="file" name="honorDismisal">
                </div>
                ...
                <div>
                    ...
                    <input id="permitCrossEnroll" class="form-control form-control-sm" type="file" name="permitCrossEnroll">
                </div>
